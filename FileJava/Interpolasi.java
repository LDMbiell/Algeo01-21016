...
public class Interpolasi {
  //Membaca matriks menggunakan file
  public static void Input(String nama_file, Matriks Min) throws FileNotFoundException { 
        ...
        if (Baris == 0) {
            System.out.println("Tidak dapat membaca file yang diinput");
        } else {
  ...
  public static void Cari() {
        ...
        if (spl == 1) {
            ...
            String nama_file = Menu.inputFile();
            try {
                Input(nama_file, M);
                M.TulisMat();
            } catch (Exception e) {
